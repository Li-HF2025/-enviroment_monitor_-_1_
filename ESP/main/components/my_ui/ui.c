...
///////////////////// VARIABLES ////////////////////
lv_anim_t * screenLockBall_Animation(lv_obj_t * TargetObject, int delay);
lv_anim_t * timeKeyboard_Animation(lv_obj_t * TargetObject, int delay);
...
void ui_init(void)
{
    ...
    ui_main01_screen_init();
    ui_main02_screen_init();
    ui_main03_screen_init();
    ui_main04_screen_init();
    ui_detailTime_screen_init();
...
void ui_destroy(void)
{
    ...
    ui_main01_screen_destroy();
    ui_main02_screen_destroy();
    ui_main03_screen_destroy();
    ui_main04_screen_destroy();
    ui_detailTime_screen_destroy();
