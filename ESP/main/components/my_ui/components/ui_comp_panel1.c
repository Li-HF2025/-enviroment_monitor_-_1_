...
lv_obj_t * ui_Panel1_create(lv_obj_t * comp_parent)
{
    ...
    lv_obj_set_width(cui_Panel1, 50);
    lv_obj_set_height(cui_Panel1, 50);
    lv_obj_set_x(cui_Panel1, 0);
    lv_obj_set_y(cui_Panel1, -50);
    lv_obj_set_align(cui_Panel1, LV_ALIGN_CENTER);
    lv_obj_set_ext_click_area(cui_Panel1, 1);
    lv_obj_remove_flag(cui_Panel1, LV_OBJ_FLAG_SCROLLABLE | LV_OBJ_FLAG_SCROLL_MOMENTUM |
